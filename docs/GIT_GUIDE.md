...
Repo: https://github.com/TIMOTHY-glitch-hash/YouperMVP
...
1. Repo owner goes to the repo → **Settings** → **Collaborators** → **Add people**
2. Enter each teammate's GitHub username or email and send the invite
3. Each teammate accepts the invite from their email or GitHub notifications
...
```bash
git clone https://github.com/TIMOTHY-glitch-hash/YouperMVP.git
cd YouperMVP
git status
```
...
```
**If you want to use an existing branch you already created:**
```bash
...
1. Use the link Git prints after pushing (e.g. `https://github.com/TIMOTHY-glitch-hash/YouperMVP/pull/new/feature/auth-setup`)
